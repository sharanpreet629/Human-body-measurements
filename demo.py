...
def main(frame, img_path, height, json_path=None):
...
#    cv2.waitKey(0)
    ...
    extract_measurements.extract_measurements(frame,img_path, height,verts[0])
    #t2 = threading.Thread(target=extract_measurements, args=(frame,img_path,height,verts[0]))
